...
if (isset($_POST['register'])) {
	...
	mysqli_query($db, "INSERT INTO users (username,email,password,name,address,role,phone) 
	VALUES ('$username','$email','$password','$name','$address','$role','$phone')"); 
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="width=800px" >
				<form class="login100-form validate-form" method="post" action="register_client.php">
          ...
          <select class="custom-select my-1 mr-sm-2" id="inlineformCustomSelectPref"name="role" >
               <option value="client"> client</option><div>
