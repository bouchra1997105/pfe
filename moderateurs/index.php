<?php
include('action.php');
$cat = ["hotel", "restaurant", "voiture"];
$vill = [
  "Adrar", "Chlef", "Laghouat", "Oum El Bouaghi", "Batna", "Béjaia", "Biskra", "Béchar", "Blida", "Bouira",
  "Tamanrasset", "", "", "", "", "", "", "", "", "",
  "", "", "", "", "", "", "", "", "", "",
  "", "", "", "", "", "", "", "", "", "",
  "", "", "", "", "", "", "", "", "", "",
  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
          ...
          <form action="action.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select class="custom-select my-1 mr-sm-2" id="inlineformCustomSelectPref" name="category">
                ...
                <?php
                foreach ($cat as $c) { ?>
                  <option value="<?php echo $c; ?>" <?php if (!empty($s) && ($s == $c)) echo 'selected="selected"'; ?>><?php echo $c; ?></option>
                <?php
                }
                ?>
              </select>
            ...
            <div class="form-group">
              ...
              <select class="custom-select my-1 mr-sm-2" id="inlineformCustomSelectPref" name="ville">
                <option value="">Select any one</option>
                <?php $ss = (isset($_GET['ville']) && $_GET['ville'] != null) ? $_GET['ville'] : "";
                foreach ($vill as $v) { ?>
                  <option value="<?php echo $v; ?>" <?php if (!empty($ss) && ($ss == $v)) echo 'selected="selected"'; ?>><?php echo $v; ?></option>
                <?php
                }
                ?>
      ...
      <div class="col-md-8">
        ...
        $id_m=$_SESSION['id'];
        $query = "SELECT * FROM biens where id_mod='$id_m'";
            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="index.php?edit=<?= $row['id_biens']; ?>&category=<?= $row['category']; ?>&ville=<?= $row['ville']; ?>" class="badge badge-success p-2">Edit</a>
                </td>
                <td> <a href="chose_a_reser.php?id_bien=<?= $row['id_biens']; ?>" class="badge badge-success p-2">add chose</a></td>
              </tr>
            <?php $i++;}; ?>
          </tbody>
        </table>
