...
$id_Bien= (isset($_GET['id_bien']) && !empty($_GET['id_bien'])) ? $_GET['id_bien'] : "";
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <form action="action_chose.php" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="id_biens" value="<?= $id_Bien; ?>">

            <div class="form-group">
              <label class="my-1 mr-2" for="selecteOp">type</label>
              <select class="custom-select my-1 mr-sm-2" id="selecteOp" name="type">
            ...
            <div class="form-group">
              <label class="my-1 mr-2" for="inlineformCustomSelectPref">Nombre de <span id="testOp"></span> </label>
        ...
        <div class="col-md-8">
          ...
          $query = "SELECT * FROM chose_a_res where id_biens=$id_Bien";
              ...
              ?>
                <tr>
                  ...
                  if ($row['type'] == "chambre") {
                    ...
                    $textNbr = "chaise";
                    $textPrix ="repas";
                  }else if($row['type'] == "voiture"){
                    $textNbr = "chaise";
                    $textPrix ="jours";
                  }
                  ?>
                  <td><?= $row['description']; ?></td>
                  <td><?= $row['nbr'] . " / $textNbr"; ?></td>
                  <td><?= $row['prix']." / $textPrix"; ?></td>
